...
mvn --batch-mode release:clean release:prepare -DreleaseVersion=$releaseVersion -Dtag=$releaseTag -DdevelopmentVersion=$devReleaseVersion ${batchBuildArg} && mvn release:perform -Dmaven.test.skip=true
