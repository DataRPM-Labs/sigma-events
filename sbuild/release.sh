...
mvn --batch-mode release:clean release:prepare -Dmaven.test.skip=true -DreleaseVersion=$releaseVersion -Dtag=$releaseTag -DdevelopmentVersion=$devReleaseVersion ${batchBuildArg} && mvn release:perform
