...
public class TestConfigRead extends TestCase {
  public void testRead() throws IOException {
    Configuration configuration = ConfigurationReader.INSTANCE.readConfiguration("test-site.xml");
    assertNotNull(configuration);

    String value = configuration.get("key1");
    assertNotNull(value);
